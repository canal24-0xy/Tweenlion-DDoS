...
def handleStatusCodes(status_code):
	...
	sys.stdout.write("\r%i \033[1;32mREQUEST SENT\033[0m" % request_counter)
	sys.stdout.flush()
	print("\033[1;33m▒▒\033[1;36m[" +str(url)+ "]\033[1;33m▒\033[1;37m▒\033[0;31m::\033[0;33mTween\033[1;36mLeon\033[0m")
	sys.stdout.flush()
	if status_code == 429:
